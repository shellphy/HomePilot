...
// joinedCta 直接写取消动作：已加入的状态由名单里的「你」承担，点按钮会先弹确认
// shareText：加入前共享开关的说明（维权不互通联系方式，没有这一项）
const TYPE_META = {
  activity: { joinCta: '报名参加', joinedCta: '取消报名', foot: '人已报名', roster: '报名名单', shareText: '与发起人互通手机号，方便拉群约时间（仅双方可见）' },
  aid: { joinCta: '算我一个', joinedCta: '退出参与', foot: '人已加入', roster: '参与名单', shareText: '与发起人互通手机号，方便对接（仅双方可见）' },
