...
return new class extends SettingsMigration
{
    ...
    public function up(): void
    {
        ...
        $this->migrator->add('community.ai_context', '小区在武汉，夏热冬冷、无集中供暖，梅雨与回南天潮湿闷热、冬天湿冷。每户只有一个空调外机位，基本只能装中央空调（一拖多）；层高约 2.95 米，吊顶后约 2.6 米。交付时门窗已封装，玻璃为双 / 三层中空夹胶、隔音隔热达标，一般无需换窗。');
