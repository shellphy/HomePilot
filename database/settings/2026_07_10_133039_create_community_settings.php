...
return new class extends SettingsMigration
{
    ...
    public function up(): void
    {
        ...
        $this->migrator->add('community.ai_context', '小区位于武汉，夏热冬冷，无集中供暖。每户只有一个空调外机位，通常采用中央空调（一拖多）。层高约 2.85 米（不含墙板；含墙板约 3 米）；普通吊顶后约 2.73 米，加地暖后约 2.6 米。交付窗整体隔音较好，临高架侧为三层玻璃；先验收，有问题再局部处理。130㎡、154㎡户型阳台按开放露台管理，不得封闭，不计入室内装修面积，室外工程另行委托和报价。');
