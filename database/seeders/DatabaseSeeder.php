            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '用途决定投入和风格——出租可从简，长期自住值得一步到位。',
                        'options' => ['婚房', '长期自住', '短期过渡', '出租', '养老'],
                        'option_notes' => ['兼顾当下和未来添丁', '一步到位、按理想来', '够住就行、控制预算', '耐用好打理、从简', '安全无障碍优先'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'option_notes' => ['小方桌或卡座', '1.2~1.4m 方桌最常见', '1.4~1.6m 或圆桌', '大圆桌 / 可拉伸桌', '考虑岛台 + 大桌、可扩展'],
                    ],
                    [
                        'key' => 'fridge', 'text' => '冰箱打算买哪种？', 'type' => 'single',
                        'note' => '冰箱尺寸要在水电和橱柜阶段定好，留电位和嵌入位（嵌入式按机器尺寸预留散热缝）。',
                        'options' => ['单 / 双门（小容量）', '三门', '十字四门', '对开门', '两台 / 加冰柜', '还没定'],
                        'option_notes' => ['小户型、单身', '经典家用', '分区细、主流之选', '大容量、开门占位', '囤货多 / 大家庭，留双电位', '先按大的预留更保险'],
                    ],
                ],
            ],
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '爆炒多 → 封闭厨房 + 大吸力烟机；轻烹为主 → 可考虑开放式。',
                        'options' => ['爆炒重油、天天做', '中式为主、常做', '轻烹 / 西餐、偶尔做', '很少做 / 点外卖'],
                        'option_notes' => ['封闭厨房、强吸油烟机', '够用的吸力和台面', '开放式、颜值优先也行', '厨房可小、留基本电器'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => ['干爽好打理，强烈推荐', '泡澡放松，注意上下水和承重', '两人同时用，早高峰不挤', '化妆护肤在卫生间搞定', '洗衣区放这、留水电地漏', '泡澡追剧', '带冲洗烘干，留防溅插座', '冬天洗澡不冷'],
                    ],
                    [
