            ...
            'payload' => [
                ...
                'glossary' => [
                    [
                        ...
                        'explain' => '这是当前了解到的参考单价，不含定制柜，也不代表每户最终一定落在这个区间。',
                        'judge' => '先统一按套内还是建筑面积计价，再逐项看基础施工、主材品牌型号、设计费、管理费和拆改是否包含。',
                        'caution' => '只看每平方米单价很容易低开高走；漏项、限量、主材降档和个性化增项必须在签约前列清楚。',
                    ],
                    [
                        'term' => '4 次主动回访',
                        'explain' => '不是等业主投诉才处理，而是在约定的设计、施工或入住节点主动联系业主。',
                        'judge' => '问清四次分别发生在什么时候、谁负责、发现问题后多久响应，以及回访记录能否留档。',
                        'caution' => '“学习胖东来”是服务理念，不等于可执行承诺；回访节点、处理时限和责任部门要写进服务附件。',
                    ],
                    [
                        'term' => '设计师聊得来',
                        'explain' => '能快速理解审美和生活需求很重要，但真正落地还要靠图纸、预算和施工交底。',
                        'judge' => '让设计师用平面方案、效果参考、材料和预算说明她如何理解你的需求，再判断是不是长期沟通得下去。',
                        'caution' => '个人沟通体验不能代替合同；要确认设计师是否全程跟进、能改几轮、换人怎么办，以及设计与施工如何交接。',
                    ],
                ],
            ],
        ];
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '亮光、柔光、哑光先解决“看起来喜不喜欢”，不直接代表耐污和防滑。尤其柔光砖，最后好不好打理，很大程度要看表面釉层和纹理是否细密。',
                    ...
                    [
                        ...
                        'note' => '“糖果釉”“金丝绒”“肌肤釉”等多是品牌对表面釉料和工艺的叫法，不是全国统一的质量等级。柔光砖容易不容易藏污，关键看釉面和纹理够不够致密、耐污染和耐磨表现怎么样，不能只听名字高级。',
                        'options' => ['摸一摸表面是否细密、有没有明显凹凸孔隙', '拿油性笔 / 咖啡等常见污渍现场试擦', '看耐污染、耐磨和防滑检测', '只认糖果釉 / 金丝绒等工艺名字', '还没概念'],
                        'option_notes' => [
                            '表面越粗糙、微孔和凹凸越明显，越可能卡灰；不过手感只能初筛，不能代替检测',
                            '先让门店确认可测试区域和清洁方式，用同样污渍、停留时间和清洁剂比较，别自行破坏样砖',
                            '客厅重点看耐污耐磨，厨房更看油污清洁，卫生间还要单独看湿态防滑',
                            '名字只能帮助认工艺，不能直接证明好擦、耐磨或防滑；同名工艺不同品牌也可能不一样',
                            '记住一句：先选喜欢的光感，再用样砖试清洁、看检测报告',
                        ],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '蹲便不是“过时选项”，客卫有人会觉得更省接触、冲洗方便；但老人、孕妇、膝腿不便的人使用坐便更轻松。洁具类型会影响坑距、排水和地面做法，水电前就要定。',
                    ...
                    [
                        ...
                        'note' => '干湿分离能减少水汽外溅，但不是玻璃淋浴房越小越好。给婴幼儿洗澡往往要放澡盆、蹲下操作，还要留一个大人的位置；门槛、窄门和向内开的玻璃门反而可能碍事。',
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '无主灯不是简单地“不要吸顶灯”，而是用筒灯、射灯、灯带等分层照明。全屋做对吊顶、回路、灯位和调试要求更高；只在客餐厅等公共区域做，卧室保留主灯，通常更省预算也更好维护。',
                        'options' => ['全屋无主灯', '只做客餐厅 / 走廊等公共区域', '主灯 + 局部筒灯 / 灯带', '不同房间按需求混搭', '还没想好'],
                        'option_notes' => [
                            '整体感强，但几乎每个空间都要提前做照明设计，吊顶、灯具数量、回路和调试费用都会增加',
                            '公共区域做氛围和层次，卧室保留主灯，比较适合想要效果又不想全屋复杂化的家庭',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '空调升温快、投入低；地暖脚下舒服，但会占层高、升温慢；暖气片升温快，但要占墙面。两联供用空气源热泵带地暖，通常比燃气壁挂炉地暖更省采暖运行费，不过前期投入更高，也更考验设计、安装和调试。',
                        ...
                        'option_notes' => [
                            ...
                            '用电把空气里的热量“搬”进家里，不是直接用电烧水，所以通常比燃气壁挂炉地暖更省运行费；具体能省多少，要按本地电价、气价、房屋保温和使用时长算。前期机器和安装一般更贵',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => [
                            '重点看低温制热能力和有没有喷气增焓。别只听“制热强”，让商家拿出具体型号在低温下的能力参数',
                            '先看卧室内机最低档有多响，再看外机夜间模式和安装减振。大金、日立部分高端内机能标到 17dB(A)，但这是具体型号、具体风档下的数据',
                            '现在家用多联机基本都是变频，没必要只问“是不是变频”。更值得看的是 APF、低频能不能稳、高负荷时够不够用',
                            '大金部分系列、日立尊睿全效Ⅱ、COLMO 图灵2.0等都有三管方案；海信 Ai 家 II Pro 则是在三管温湿双控基础上增加热回收第四管。管子多不自动等于更好，要问清分别解决除湿、地暖、热水还是热回收',
                    ...
                    [
                        ...
                        'note' => '建议继续问。双转子、摆动式、涡旋式是不同做法，不等于简单的低中高档。国产家用多联机常见双转子，大金部分机型用摆动式，涡旋更多出现在部分大容量或特定高端机型。同一个系列换个容量，压缩机都可能不一样，所以一定要落到完整外机型号。',
                    ...
                    [
                        ...
                        'note' => '这就是大家常说的“低频能力”：做得好，空调不用反复启停，温度更稳，也更安静。高频则关系到刚开机能不能快速降温、极端天气能不能顶住。但最低 6Hz、最高多少 Hz 都不能只看数字，还要问清测试条件、能效和噪声。',
                    ...
                    [
                        ...
                        'note' => '送风方式会直接影响体感。普通单出风、3D 气流、高静压远送风各有适合的空间。美的领航者新款的上下双出风比较有辨识度：夏天兼顾送远和均匀，冬天能把热风往下送，改善“头热脚冷”。不过最终还得看房间形状、吊顶和具体内机型号。',
                    ...
                    [
                        ...
                        'note' => '除了主品牌，还会遇到 COLMO、卡萨帝这类独立高端品牌，以及各家的高端产品系列。高端定位不自动等于更适合你家，也别拿一个品牌的入门款去和另一个品牌的旗舰款比。最后要落到同等级的具体系列、容量、安装、售后和总价。',
                        'options' => ['大金', '日立', '三菱电机', '三菱重工', '东芝', '美的', 'COLMO', '格力', '海信', '海尔', '卡萨帝', '暂不按品牌筛选'],
                        'option_notes' => [
                            '别只问“大金多少钱”，要问清具体系列、压缩机、三管能力、内机和安装标准',
                            '尊睿全效Ⅱ主打三管温湿双控、补气增焓，部分内机低至 17dB；压缩机仍要按外机型号确认',
                            '重点比较具体系列的压缩机、能效、静音和本地安装售后，不要和三菱重工混为同一品牌',
                            '和三菱电机是两家公司、两套产品体系；先确认当地在售系列、渠道、安装班组和备件',
                            '先确认国内在售的具体系列、压缩机路线、内机选择，以及当地渠道和后续配件是否稳定',
                            '领航者新款重点看 6Hz 低频、上下双出风和制热，这些是不是刚好解决你的痛点',
                            'COLMO 是美的集团旗下独立高端品牌。图灵2.0中央空调主打三管制温湿控制，还要结合具体配置比较全屋智能、安装服务和溢价是否值得',
                            '重点看看新款 Star5 AI，也要和其他 GMV 家用系列按容量、低温能力、能效、内机和落地价一起比',
                            '日立和海信不能只看成同一套产品。海信 Ai 家 II Pro 主打6合1四管制，其中包含三管温湿双控和第四管热回收；仍要核对具体型号、功能边界和落地价',
                            '单独看海尔具体家用多联机系列、低温制热、智慧控制、本地安装和售后，不要只按国产品牌打包比较',
                            '海尔旗下独立高端品牌，不是海信；重点比较具体中央空调系列、舒适功能、成套智慧体验、专属服务和价格差',
                            '也可以。先把需求和房间负荷算清楚，再看谁家的方案真正合适',
                        ],
                    ],
                    [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => [
                            ...
                            '口头承诺无效，规格、品牌都要落到合同上；铜管超出套餐长度通常另收费，签约前问清计价方式和单价',
                            '长风口通常会加钱。要问清按米还是按整条收费、包含什么材质；还要分清整条都能出风，还是只有内机对应位置是真出风、其余只是为了好看。回风面积、噪声和结露风险也要让设计师一起核对',
