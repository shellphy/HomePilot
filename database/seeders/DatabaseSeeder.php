            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '先记录原房问题，才能分清是开发商整改还是装修施工：重点检查墙地面空鼓开裂、门窗渗漏、排水是否通畅、阴阳角和层高，并拍照留档；仍在保修期内的，先报修再开工。',
                    ...
                    [
                        ...
                        'note' => '中央空调、新风、地暖、热水、净水、橱柜和嵌入式电器会争吊顶、墙面和地面空间。水电开槽前让设计、施工和相关设备方按同一张图联合交底，核对孔洞、管线、插座、上下水、检修口和完成面高度，能避免各做各的、后期打架。',
                    ...
                    [
                        ...
                        'note' => '承重墙、梁、柱等主体结构不得擅自拆改，不能只凭墙体厚薄判断，要以结构图和物业审批为准；新旧墙交接等易开裂部位应按材料和施工方案做拉结、挂网或其他抗裂处理。',
                    ...
                    [
                        ...
                        'note' => '点位 = 每个插座和开关，埋进墙里、装完后增加成本很高。先按家电功率、同时使用情况和回路来设计，线径与空开由电气设计和规范核定，不能只套用固定数字；大功率电器通常要独立回路，强弱电也要按规范分隔。',
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '换窗属于拆改阶段的活。开发商原窗隔音隔热差的，可按风压、气密、水密、玻璃和安装节点综合选型，不能只看「断桥铝」四个字；封阳台须先确认规划和物业要求，不能默认可封；阳台做洗衣区要提前留水电和排水。',
                    ...
                    [
                        ...
                        'note' => '隔音要先找声源：临街噪声重点看窗的玻璃配置、密封和安装；邻墙人声可做独立龙骨 + 吸声材料 + 双层板；排水噪声要包管并留检修条件。只贴一层薄「隔音棉」通常解决不了所有问题。',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '卫生间地面、墙面以及管根和门口等节点要按设计与当地规范做防水，淋浴区通常做得更高；厨房、阳台是否做及范围要结合用水、地漏和规范确定。防水完成并达到养护要求后做闭水或淋水检验，时长按材料说明、规范和物业要求执行，合格后再进入下一道工序。',
                    ...
                    [
                        ...
                        'note' => '亮光、柔光、哑光描述的是表面效果，不直接等于防滑或好打理；卫生间等湿区要单独看防滑等级，墙地砖还要结合吸水率、耐磨、防污和铺贴条件。岩板属于大规格板材，不是光泽度分类，常用于台面或墙面，施工和修边要求更高。',
                    ...
                    [
                        ...
                        'note' => '贴砖前先出排版图，确认起铺点、通缝、门口收口、窄条位置、地漏和墙面设备中心线；湿区还要核对地面坡向和门口高差。铺贴后等材料达到检验条件，再检查平整度、接缝、空鼓，并做地漏和下水通水测试，不能只看表面齐不齐。',
                    ...
                    [
                        ...
                        'note' => '美缝通常在基层和瓷砖充分干燥后施工，作用是填缝、防污并改善观感。水泥基填缝剂、反应型树脂填缝剂和环氧彩砂各有适用空间，并非简单的等级排序；重点看执行标准和检测报告、耐水耐污需求、砖面适配、施工质量与后续可维修性，潮湿区域还要先解决基层渗水。',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '开放式显大、动线好，但要结合当地燃气条件、消防要求和烹饪习惯决定。橱柜属于全屋定制，但布局和嵌入式电器要在硬装阶段定好尺寸、回路、上下水；同时检查烟道、止回装置和排烟孔条件。燃气管道、表具和阀门不得由普通装修人员擅自改动。',
                    ...
                    [
                        ...
                        'note' => '干湿分离更干爽，但要给门扇、通道和清洁留够尺寸；台盆墙排更简洁，却更依赖管径、坡度、存水弯和检修条件，不应只追求外观。壁挂马桶、入墙花洒等要在硬装阶段确认结构、检修和预埋。下沉式卫生间的回填或架空方案应控制荷载并保护管线，不能直接用尖锐、混杂的建筑垃圾回填。',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '灯具可以后买，但灯位、回路、开关和调光方式要在水电阶段确定。先按会客、用餐、阅读、起夜、观影、清洁等场景规划，避免只追求筒灯数量；无主灯还要提前核对防眩、照度、色温、显色性和驱动检修位置。',
                    ...
                    [
                        ...
                        'note' => '吊顶用于协调管线、设备、灯具和造型，代价是降低净高。造型前先叠合梁、风口、喷淋、窗帘盒、柜门和灯位，给阀门、设备和驱动留可操作的检修口；石膏板接缝、转角和不同材料交接要按系统做抗裂处理。优先采用适配空间和荷载的成套材料，若有木基层还要按要求做防火、防腐处理。',
                    ...
                    [
                        ...
                        'note' => '主流是乳胶漆，也可局部用艺术涂料、墙布墙纸或护墙板。最终效果取决于基层含水率、腻子适配和平整度、底漆面漆体系及施工环境；不要让现场随意添加来源不明的胶水或粉料，产品应按说明书配套使用并保留包装和检测资料。',
                    ...
                    [
                        ...
                        'note' => '门的名称和内部结构并不总是一一对应：实木复合门可能使用木方、桥洞力学板或其他复合芯材，原木门也要关注含水率和变形风险。选门应让商家写清门扇结构、饰面、环保等级、隔音需求、五金和安装收口；通顶门更重，对门扇稳定性和五金要求也更高。',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '室内空气风险不只甲醛，还包括苯系物、总挥发性有机物和氡等，来源和释放周期不同，不能用气味或单一“零甲醛”宣传判断。采购时核对与产品类别对应的现行国家标准和检测报告，控制人造板、胶黏剂和涂料的总用量；完工后充分通风，入住前需要检测时选择具备资质的机构。',
                    ...
                    [
                        ...
                        'note' => '常见几种：① 整装 / 全包公司——设计、施工、主材全包，省心，本地行情约 1000~1500 元/㎡（1000~1300 性价比、1300~1500 中等、1500 以上偏贵；一线城市更高）；② 半包——公司出人工 + 辅料、主材自己买，约 500~800 元/㎡，能自己控主材品牌；③ 清包——只请工人、所有材料自己买，最省钱也最费心；④ 游击队 / 熟人队——便宜但没合同没售后、风险高。另外，报价按什么面积算很关键——按「建筑面积」比「套内面积」贵一截，套内还分含不含墙体；咱们小区是四代住宅、带露台（不能封、属室外），装修公司一般不做室外工程，露台不该算进计价面积，比价前先统一面积口径。',
