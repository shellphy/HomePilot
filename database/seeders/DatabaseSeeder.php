            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '当下热门：现代简约、奶油风（奶白柔软、温馨）、侘寂风（低饱和、自然肌理、朴素）、新中式（宋式美学，米咖麻色）、法式（优雅，现融入简约线条）、中古风（拱门、开放、复古家具）、日式原木（MUJI 风）。风格边界越来越模糊，混搭是常态，选一个主调再点缀。',
                        'options' => ['现代简约', '奶油风', '侘寂风', '新中式 / 宋式', '法式', '中古风', '日式原木 / MUJI', '还没想好'],
                        'option_notes' => ['百搭耐看、好落地', '奶白柔软、温馨治愈，当下最热', '低饱和、自然肌理，讲究朴素留白', '米咖麻色、东方雅致，宋式更简约', '优雅浪漫，现在多融现代简约线条', '拱门开放 + 复古家具，层次感强', '原木 + 棉麻，自然清爽好打理', '先看讲解找找感觉，也可混搭'],
                    ],
                    [
                    ...
                    [
                        ...
                        'options' => ['原木', '布艺 / 棉麻', '皮革', '金属', '藤编 / 草编', '石材 / 大理石', '玻璃 / 亚克力'],
                        'option_notes' => ['温润自然，百搭治愈系', '柔软亲肤，营造松弛感', '沉稳有档次，点缀或主沙发', '现代感、精致感，小面积点睛', '自然手作感，适合日式侘寂', '大气高级，电视墙 / 餐桌常用', '通透轻盈，显空间'],
                    ],
                ],
            ],
            [
