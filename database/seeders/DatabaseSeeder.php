        ...
        return [
            ...
            'payload' => [
                ...
                'terms' => [
                    ...
                    ['label' => '参考价格', 'value' => '硬装全包约 1000~1300 元/㎡，不含定制柜；最终按室内计价面积、主材清单和个性化项目核算。130㎡、154㎡户型露台不计入室内面积，露台工程另行委托和报价'],
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => [
                            '脚感舒服；别只认“纯铜”三个字，保温、管路、分水器和打压都要做好',
                            '升温快、适合小面积，大面积长期开电费高',
                    ...
                    [
                        ...
                        'option_notes' => ['先检查密封和安装缝；隔音满足需求即保留', '结构要避免刚性声桥，施工会占少量室内尺寸', '包管同时处理吊顶和穿墙缝，别封死检修口', '关注门扇密度、四周密封和门底缝', '不必为没有的问题堆材料，先实地听噪声'],
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => ['优先低释放板材，但别觉得“全屋 ENF 就稳了”——板子越多，叠加越要留心', '认准新国标合格线，别用三无材料', '至少守住新国标底线，别贪便宜买路边货'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'option_notes' => ['可按负荷和同开率设计，不直接套固定超配比例', '核对主要生活动线和高峰同时使用情况', '武汉火炉、同开率高，按计算负荷选外机别配小，合同写清内外机完整型号'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => [
                            '预算最省；带热泵的喷气增焓机型冬天基本够用，有地暖更暖脚不干',
                            '脚感均匀，但影响层高、热源和后期维护',
                            '升温快、后期能明装；占墙面、体感不如地暖',
                            '安装简单、适合局部；大面积长期开电费偏高',
                            '靠热泵「搬」热量、不是直接电加热，运行费通常比燃气地暖省；能省多少看本地电价气价和保温，前期更贵',
                            '顶面辐射制冷、地面辐射供暖都用水，全屋几乎无风感、温湿分控最舒适；但顶面制冷必须配新风除湿防结露，造价和设计施工门槛都更高',
                    ...
                    [
                        ...
                        'option_notes' => [
                            '优先双向流全热交换；有鼻炎 / 过敏就看滤芯到没到 HEPA、能不能滤花粉尘螨，每屋是否都送到',
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => [
                            ...
                            '省不省电要比同类型、同容量的 APF（全年能效，通常越高越省电）',
                    ...
                    [
                        ...
                        'option_notes' => [
                            ...
                            '例如美的领航者新款主打 6Hz，也要问是哪款机、什么条件下做到的；把低频、平时能效和满负荷放一起看',
                    ...
                    [
                        ...
                        'option_notes' => [
                            ...
                            '新款 Star5 AI 改用格力自研补气增焓压缩机（最低 4Hz）、不再靠三菱电机；不同容量 / 老款可能不同，认准外机型号确认压缩机来源',
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => ['碎料压制，性价比高、饰面丰富、变形小；握钉力和防潮一般，重点看等级和板边封边', '多层木皮交错胶合，握钉和防潮通常更好、价格更高；认准胶合质量和环保报告', '大片定向刨花，结构强、甲醛通常较低；表面偏粗，饰面适配和加工要求高', '秸秆等纤维 + MDI 胶，主打无醛添加；防潮握钉看具体产品，环保仍以检测为准', '按柜体结构、干湿环境和预算逐项比，别只认名字'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => ['坐感舒服、款式多，选可拆洗款', '别光信“科技布”三个字，现场试试耐磨和清洁，也问清掉皮怎么修', '有档次、好打理，预算够可上', '能灵活组合，适合大客厅', '按有没有宠物小孩、预算再定'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'option_notes' => ['基础必备', '南方回南天、冬天神器', '省地方，量大稍慢', '衣物平整，留个角落', '洗晾烫收一体，动线最顺', '家务放露台，留上下水和防水'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'option_notes' => ['夏天制冷、一拖多', '冬天地面采暖、最舒服', '升温快、不占层高', '关窗也换气、过滤除霾花粉，鼻炎 / 过敏更友好', '喝水用水更放心', '洗浴不涩、护热水器', '灯光窗帘家电联动', '观影氛围拉满', '摄像头、门磁提前布点', '先勾着，慢慢定'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'option_notes' => ['确认服务深度、修改次数和施工配合', '人工和辅料，明确拆改、水电、防水等范围', '按空间列品牌型号、数量、损耗和安装', '按图纸、板材、五金、台面和安装计入', '沙发、床、桌椅、窗帘和装饰', '灯具、厨房、清洁和影音等电器', '单列设备、辅材、安装、控制和维护', '容易漏报，签约前统一是否含税及收费主体', '不计入每平方米套餐，单独委托和报价', '建议独立保留，不提前花在非必要升级上'],
                    ],
                    [
