    ...
    private function hardFinishModules(): array
    {
        return [
            ...
            [
                'key' => 'plumbing',
                'title' => '拆改与水电（隐蔽工程）',
                'intro' => '水电是埋进墙地里的「隐蔽工程」，装完最难改、也最影响日后生活，是硬装里最要上心的一步。',
                'questions' => [
                    [
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'note' => '瓷砖耐用好打理、配地暖导热快；木地板脚感暖但怕水怕潮；不少人客厅铺砖、卧室铺木地板。铺木地板要提前预留和瓷砖的高度差找平。',
            ...
            [
                ...
                'questions' => [
                    [
                        'key' => 'ceiling', 'text' => '吊顶打算怎么做？', 'type' => 'single',
                        'note' => '吊顶会降层高（20~30cm）。厨卫一般用石膏板或铝扣板吊顶藏管线；客厅看风格，做「无主灯」（筒灯、灯带藏进吊顶）更高级，但要求墙顶极平（得用更贵的「冲筋找平」）。龙骨优先国标轻钢，厨卫石膏板要用防水的。',
                        'options' => ['简单吊顶 / 走个边', '全屋无主灯设计', '只做厨卫吊顶', '还没定'],
                        'option_notes' => ['省层高、省钱，够用', '效果高级但造价高、对找平要求高', '厨卫必须吊顶藏管线，其余留白', '看风格和层高再定'],
                    ],
                    [
            ...
            [
                ...
                'questions' => [
                    [
                        ...
                        'note' => '甲醛主要来自板材、腻子里的胶、劣质美缝，多种材料叠加更要当心。认准环保认证：板材看 ENF 级，腻子 / 乳胶漆看新国标和十环 / 法国 A+，美缝看 GB18583。家里有小孩、老人尤其要卡等级。',
